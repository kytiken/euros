defmodule Euros.CoreTest do
  ...
  describe "Euros.Core.crawl/4" do
    test "every page" do
      url = "https://euros-test.blogspot.com/"
    ...
    test "with option depth_limit is nil" do
      url = "https://euros-test.blogspot.com/2018/01/"
               ...
               fn page ->
                 ...
                 assert Enum.member?(
                          [
                            ...
                            "https://euros-test.blogspot.com/2017/12/",
                            "https://euros-test.blogspot.com/2018/01/",
                            "https://euros-test.blogspot.com/2017/12/image-page-test.html",
                            "https://euros-test.blogspot.com/2017/12/test1.html",
                            "https://euros-test.blogspot.com/2017/12/other-host-link-test.html",
                            "https://euros-test.blogspot.com/2018/01/january.html",
                            "https://euros-test.blogspot.com/search?updated-max=2018-01-06T17:17:00%2B09:00&max-results=7"
                          ],
                          page.request_url
                        ),
                        page.request_url
