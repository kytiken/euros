defmodule Euros.CoreTest do
  ...
  describe "Euros.Core.crawl/4" do
    ...
    test "with option depth_limit is nil" do
      ...
      assert Euros.Core.crawl(url, fn(page) ->
        assert 200 === page.status_code
        assert Enum.member?(["https://euros-test.blogspot.jp/",
                            ...
                            ], page.request_url), page.request_url
      end, option) == :ok
    end
    ...
    test "with option depth_limit is 0" do
      ...
      assert Euros.Core.crawl(url, fn(page) ->
        assert 200 === page.status_code
        assert Enum.member?(["https://euros-test.blogspot.jp/2018/01/"], page.request_url), page.request_url
      end, option) == :ok
    end
